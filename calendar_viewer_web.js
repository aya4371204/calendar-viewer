...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function openBookingModal(room, startTime) {
        const endTime = new Date(startTime.getTime() + 30 * 60000); // Default 30 min meeting
    ...
    async function createCalendarEvent() {
        ...
        try {
            await gapi.client.calendar.events.insert({ 'calendarId': targetCalendarId, 'resource': eventResource });
